            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <c:if test="${sessionScope.ad_account.role.toString() eq 'admin'}">
                            Admin
                        </c:if>
                        <c:if test="${sessionScope.ad_account.role.toString() eq 'Super_admin'}">
                            Super Admin
                        </c:if>
                    </div>
                </nav>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="add-action mb-2">
                            <a class="btn btn-success waves-effect" href="<%=request.getContextPath()%>/admin/add-new-category">
